...
var Calc = function (_React$Component2) {
    ...
    _createClass(Calc, [{
        ...
        value: function render() {
            ...
            var cel = scale === 'f' ? tryConvert(temp, toCel) : temp;
            var fahr = scale === 'c' ? tryConvert(temp, toFahr) : temp;
            ...
            return React.createElement(
                ...
                React.createElement(BoilingVerdict, { cel: cel })
            );
        }
    }]);
...
ReactDOM.render(React.createElement(Calc, null), document.querySelector('#boiling-verdict'));